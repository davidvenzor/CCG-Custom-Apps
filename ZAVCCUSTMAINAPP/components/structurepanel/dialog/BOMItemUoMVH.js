...
sap.ui.define([
	 ...
	 * @version 9.0.1
	 * @public
	 * @alias sap.i2d.lo.lib.zvchclfz.components.structurepanel.dialog.BOMItemUoMVH
	 * @extends sap.ui.core.Control
	 */
	var aColumns = [
		{
			"label": i18n.getText("vchclf_structpnl_bom_uom_vh_label"),
			"template": "UnitOfMeasure"
		},
		{
			"label": i18n.getText("vchclf_structpnl_bom_uom_description_vh_label"),
			"template": "UnitOfMeasureLongName"
		}
	];

	return BOMItemBaseVH.extend("sap.i2d.lo.lib.zvchclfz.components.structurepanel.dialog.BOMItemUoMVH", {
		...
		setControl: function (oControl) {
			...
			this._oBOMItemVHDialogConfigModel.setData({
				...
				title: i18n.getText("vchclf_structpnl_bom_uom_vh_title"),
				filters: aColumns
			});
		...
		onOk: function (oEvent) {
			...
			oBOMItemDialogModel.setProperty("/Unit", oEvent.getParameter("tokens")[0].getKey().toUpperCase());
